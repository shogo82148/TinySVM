...
SWIGEXPORT jint JNICALL Java_org_chasen_tinysvm_TinySVMJNI_BaseExample_1get_1_1SWIG_10(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4) {
  ...
  temp4 = *(TinySVM::feature_node **)&jarg4;
  arg4 = &temp4; 
...
SWIGEXPORT jlong JNICALL Java_org_chasen_tinysvm_TinySVMJNI_SWIGModelUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
...
SWIGEXPORT jlong JNICALL Java_org_chasen_tinysvm_TinySVMJNI_SWIGExampleUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
